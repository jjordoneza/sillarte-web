...
export const products: Product[] = [
  ...
  },
  {
    ...
    galeria: [
      ...
      "/products/silla-alta-negra.jpg",
      "/products/silla-alta-medidas.jpg",
    ],
    ficha: {
      "Alto total": "95 cm",
    ...
    descripcionCorta:
      "Silla alta fija con brazos, asiento en vinil piel sobre estructura de madera de pino y base en acero laqueado, disponible en beige o negro. Se vende por unidad, lista para combinar con el resto de la familia.",
    descripcionLarga:
      "Fija, con brazos, para barra de cocina o desayunador. Su asiento en vinil piel está relleno de espuma de poliuretano sobre una estructura interna en madera de pino, montado sobre una base de acero con acabado laqueado en beige o negro y pintura epoxi. Sus apoyabrazos la hacen especialmente cómoda para sesiones largas en la barra. El asiento en vinil piel es fácil de limpiar y resistente al uso diario, la base en acero con pintura epoxi resiste la corrosión, y soporta hasta 120 kg de peso. Se vende por unidad.",
  },
  {
    slug: "silla-trama",
    name: "Silla Trama",
