      ...
      <div className="mx-auto grid max-w-7xl gap-12 md:grid-cols-2 md:items-center">
        <div>
          ...
          <p className="mt-6 max-w-xl text-lg leading-8 text-black/70">
            Sillas y mesas modernas para hogares, terrazas, restaurantes y proyectos comerciales en Colombia.
          </p>
          <div className="mt-10 flex flex-col gap-4 sm:flex-row">
            <a href="#productos" className="rounded-full bg-[#2E2E2E] px-7 py-4 text-center text-white">
              Ver productos
            </a>
            <a
              href="https://wa.me/573001234567?text=Hola%2C%20quiero%20conocer%20los%20productos%20de%20SILLARTE."
              target="_blank"
              className="rounded-full border border-[#2E2E2E] px-7 py-4 text-center"
            >
        ...
        <div className="min-h-[520px] rounded-[2rem] bg-[#A67856] p-6">
          <div className="flex h-full min-h-[480px] items-center justify-center rounded-[1.5rem] border border-white/30 bg-[#EDE4CC]/20 text-center text-white">
            <p className="max-w-xs text-lg">
              Aquí irá la fotografía principal de tus productos SILLARTE.
            </p>
          </div>
        </div>
      </div>
